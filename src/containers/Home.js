    ...
    <div className="Home">
        ...
        <div className="backgroundphoto" style={{backgroundImage: 'url(${https://wholesale-ls-marketing.s3.amazonaws.com/Modena+Home+House.jpg}'}}>
          ...
          <Jumbotron>
            <div className="container">
              ...
              <Button variant="success" href="#">Search Properties</Button>
                {/* <FormGroup>
                  <Row>
                    <Col xs={6}>
      ...
      <div className="about-us-container">
        <Row className="about-us-text">
          <Col xs={6}>
            <h1>About Us</h1>
            <h3>Welcome to the First Real Estate Marketplace for Off-Market Properties. </h3>

              <h3>We Work exclusively with Real Estate Wholesalers to find you undervalued property that are ready to flip in one convenience platform. </h3>

              <h3>Instead of scouring through MLS or your Real Estate Broker for deals, come browse our selection of private home owners in need of a quick sale. 
            </h3>
            <div class="title-underline"></div>
          </Col>
          <Col xs={6}>
            <img src="https://wholesale-ls-marketing.s3.amazonaws.com/Modena-keys2.jpeg"></img>
          </Col>
        </Row>
      </div>
      ...
      <div className="grid-template">                
        <Row>
            ...
            <Col xs={6}>
                <Card className="browse-property" as="a" onClick={"/properties"} style={{ cursor: "pointer"}}>
                  <CardImg variant="top" src="https://wholesale-ls-marketing.s3.amazonaws.com/Modena-browse+property.jpg" />
                    <CardBody>
                      <CardTitle>Find your Ideal Contract</CardTitle>
                        <CardText tag="p">
                          Search through our entire listing of property contracts to find one that suits your criterias.
                        </CardText>
            ...
            <Col xs={6}>
              <Row>
                <Col xs={6}>
                  <Card as="a" onClick={"/properties"} style={{ cursor: "pointer"}}>
                      <CardImg variant="top" src="https://wholesale-ls-marketing.s3.amazonaws.com/Modena-Message.jpg" />
                        <CardBody>
                          <CardTitle>Message the Seller</CardTitle>
                            <CardText tag="p">
                              Inquiry directly with the wholeseller regarding the contract. 
                            </CardText>
                 ...
                 <Col xs={6}>
                    <Card as="a" onClick={"/properties"} style={{ cursor: "pointer"}}>
                        <CardImg variant="top" src="https://wholesale-ls-marketing.s3.amazonaws.com/modena-houseviewing.jpg" />
                          <CardBody>
                            <CardTitle>Schedule a Showing</CardTitle>
                              <CardText tag="p">
                                Coordinate a time to view the property in person prior to purchase. 
                              </CardText>
              ...
              <Row>
                <Card as="a" onClick={"/properties"} style={{ cursor: "pointer"}}>
                  <CardImg variant="top" src="https://wholesale-ls-marketing.s3.amazonaws.com/Modena-Transaction.jpg" />
                    <CardBody>
                      <CardTitle>Purchase the Contract</CardTitle>
                        <CardText tag="p">
                          Finalize the details and purchase the contract from the wholeseller. 
                        </CardText>
